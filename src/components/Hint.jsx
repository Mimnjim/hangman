...
export default function Hint({ word, guessedLetters, setGuessedLetters, setWrongAttempts }) {
    ...
    const isProcessingRef = useRef(false); // Protection contre double-clics, permet d'éviter de compter 2 indices d'un coup
    ...
    const handleConfirmHint = () => {
        ...
        isProcessingRef.current = true; // Bloquer pendant le traitement
